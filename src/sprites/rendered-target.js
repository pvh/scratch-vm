...
class RenderedTarget extends Target {
     ...
     * @constructor
     */
    constructor(sprite, runtime, automergeObjectId) {
        super(runtime, sprite.blocks, automergeObjectId);
        console.log('runtime', runtime, this);
